...
#             # print(f"grad_output = {grad_output.shape} and {type(grad_output)}")
#             # print(f"saved_input = {saved_input.shape} and {type(saved_input)}")
#             # print(f"mean = {mean.shape} and {type(mean)}")
#             # print(f"invstd = {invstd.shape} and {type(invstd)}")
#             # print(f"weight = {weight.shape} and {type(weight)}")
#             # print(f"sum_dy = {sum_dy.shape} and {type(sum_dy)}")
#             # print(f"sum_dy_xmu = {sum_dy_xmu.shape} and {type(sum_dy_xmu)}")
#             # print(f"count_tensor = {count_tensor.shape} and {type(count_tensor)}")
